...
CRUD_DELETE_CONFIRM = "Удалить запись <code>{pk}</code> из «{title}»? Это необратимо."
CRUD_DELETED = "🗑 Запись удалена."
CRUD_FK_BLOCKED = (
    "Не получилось: на эту запись ссылаются другие данные (внешние ключи). "
    "Сначала удалите или отвяжите их."
)
