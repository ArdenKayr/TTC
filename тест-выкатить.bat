@echo off
rem Deploy the current commit to the TEST environment (/opt/ttc-test).
rem Just double-click this file. Nothing on the production bot is touched.
rem
